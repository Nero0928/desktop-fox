...
export class ChatGLMProvider implements AIProviderAdapter {
  ...
  readonly definition: ProviderDefinition = {
    ...
    authHeader: true,
    enabled: true,
    envKey: 'CHATGLM_API_KEY',
    models: [
      { id: 'glm-4-flash', name: 'GLM-4 Flash', input: ['text'], contextWindow: 131072, maxTokens: 131072, cost: { input: 0.1, output: 0.3 } },
      { id: 'glm-4', name: 'GLM-4', input: ['text'], contextWindow: 131072, maxTokens: 131072, cost: { input: 1.0, output: 3.0 } },
      { id: 'glm-4-plus', name: 'GLM-4 Plus', input: ['text', 'image'], contextWindow: 131072, maxTokens: 131072, cost: { input: 2.0, output: 6.0 } }
    ]
  }
